  ...
  return (
    <div className="min-h-screen bg-void flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-glow/5 rounded-full blur-3xl" />
        {/* Grid pattern */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {mode === 'home' && (
          <div className="space-y-3 animate-fade-in">
            <button
              ...
              className="w-full flex items-center justify-between px-6 py-4 bg-accent hover:bg-accent-bright 
                         rounded-2xl text-white font-display font-semibold text-lg transition-all 
                         shadow-accent-glow hover:shadow-lg group"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-6 py-4 bg-panel hover:bg-surface 
                         border border-border hover:border-accent/40 rounded-2xl text-white 
                         font-display font-semibold text-lg transition-all group"
            >
              <span className="flex items-center gap-3">
        ...
        {mode === 'create' && (
          <div className="bg-panel border border-border rounded-2xl p-6 space-y-4 animate-slide-up shadow-card">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-surface border border-border rounded-xl text-white 
                             font-body placeholder-slate-600 focus:outline-none focus:border-accent/50 
            ...
            {error && (
              <p className="text-danger text-sm font-body bg-danger/10 border border-danger/20 rounded-xl px-3 py-2">
                {error}
              </p>
            )}
            ...
            <button
              ...
              className="w-full py-3.5 bg-accent hover:bg-accent-bright disabled:opacity-40 
                         disabled:cursor-not-allowed rounded-xl text-white font-display font-semibold 
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-surface border border-border rounded-xl text-white 
                               font-mono placeholder-slate-600 focus:outline-none focus:border-accent/50 
                               focus:ring-1 focus:ring-accent/30 transition-all tracking-widest uppercase"
                    maxLength={8}
                  />
                </div>
              </div>
